     ...
     <div>
        ...
        <div>
            <div className="flex mt-[10px] ml-[37px] gap-1.5">
                <img src="/assets/Meli+/usuario.webp" alt=""
            ...
            <div className="text-[12px] mt-[12px] ml-[35px] mb-[20px]">
                <p>Termos e condições Promoções Como cuidamos da sua <br /> privacidade AcessibilidadeInformações sobre <br /> seguros Blog Afiliados Tendências</p>
                <p className="mt-[12px] text-[gray]">© 1999-2025 Ebazar.com.br LTDA.</p>
                <p className=" text-[gray]"> CNPJ n.º 03.007.331/0001-41 / Av. das Nações Unidas, <br />
                 nº 3.003, Bonfim, Osasco/SP - CEP 06233-903 - <br />
                  empresa do grupo Mercado Livre</p>
            </div>
        </div>
     </div>
    </>
