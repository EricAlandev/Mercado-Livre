...
const PraVoce = () => {
    let Produtos = [
        {id : "1", emCima : "Visto Recentemente",
            image : "/assets/Recentes/FoneOuvido.webp",
            name : "Fone Ouvido Retorno Palco Celular Esportivo...",
            priceDiscount : "R$ 45.99",
            price : "R$ 39.99",
            descricao : "Frete grátis"},

        {id : "2", emCima : "Também te Interessa",
                image : "/assets/Recentes/Microfone.webp",
                name : "Kit Profissional Microfone Condensador Bm800...",
                price : "R$ 87.90",
                descricao : "Frete grátis"},

        {id : "3", emCima : "O que você quer",
            image : "/assets/Recentes/Notebook.webp",
