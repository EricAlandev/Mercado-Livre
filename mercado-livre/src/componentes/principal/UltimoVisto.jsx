...
const UltimoVisto = () => {
  ...
  return (
    <>
      {/*Versão para o Mobile da aba Inspirado no último visto */}
         ...
         ">
          <div>
            <ProductCard
              ...
              productSize="w-[140px] border-[2px] border-[#F1F1F1]"
            />
          </div>
          ...
          <div>
            <ProductCard
              ...
              productSize="w-[140px] border-[2px] border-[#F1F1F1] ml-[60px]"
            />
          </div>
          ...
          <div>
            <ProductCard
              ...
              productSize="w-[140px] h-[260px] border-[2px] border-[#F1F1F1]"
            />
          </div>
      ...
      {/*Versão para Desktop da aba Inspirado no último visto */}
